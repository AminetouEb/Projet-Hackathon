-- Initialisation au premier démarrage du conteneur Postgres (PGDATA en tmpfs = RAM).
-- Le rôle app_readonly doit utiliser le même mot de passe que DB_PASSWORD dans docker-compose.
...
-- =========================================
-- 5. UTILISATEUR APPLICATIF (LECTURE SEULE)
-- =========================================
-- Mot de passe aligné sur DB_PASSWORD / POSTGRES_APP_PASSWORD dans docker-compose.
-- default_transaction_read_only : aucune écriture possible, même en cas d’erreur de GRANT.

CREATE ROLE app_readonly WITH LOGIN PASSWORD '1234';

GRANT CONNECT ON DATABASE environmental_db TO app_readonly;
GRANT USAGE ON SCHEMA public TO app_readonly;
GRANT SELECT ON environmental_footprint TO app_readonly;
GRANT SELECT ON environmental_footprint_raw TO app_readonly;
